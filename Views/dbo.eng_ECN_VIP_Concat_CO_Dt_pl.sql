...
CREATE VIEW [dbo].[eng_ECN_VIP_Concat_CO_Dt_pl] as 
...
JOIN dbo.eng_ECN_VIP t1 ON e.ECN=t1.ECN 
)
...
--  ORDER BY ECN
--  FOR XML PATH('')),1,1,'')
--FROM dbo.eng_ECN_VIP T2 JOIN dbo.eng_ECN e ON T2.ECN=e.ECN JOIN dbo.inp_Picklist_CO_Dt p ON p.Dt=e.ADM_Appr_Dt
--GO
