...
CREATE VIEW [dbo].[ref_eng_ECN_Header_CO_pl] AS
...
SELECT DISTINCT e.[ECN]
  ...
  LEFT JOIN dbo.eng_ECN_Loc_CO_pl l ON e.ECN=l.ECN
  LEFT JOIN dbo.eng_ECN_Reason_Concat_CO_pl r ON e.ECN=r.ECN
  LEFT JOIN dbo.eng_ECN_Note_Concat_CO_pl n ON e.ECN=n.ECN
  LEFT JOIN dbo.eng_ECN_VIP_Concat_CO_pl v ON e.ECN=v.ECN
