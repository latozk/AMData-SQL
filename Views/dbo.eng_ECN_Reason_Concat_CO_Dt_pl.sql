...
CREATE VIEW [dbo].[eng_ECN_Reason_Concat_CO_Dt_pl] as 
...
JOIN dbo.eng_ECN_Reason t1 ON e.ECN=t1.ECN 
)
...
--  ORDER BY ECN, Seq
--  FOR XML PATH('')),1,1,'')
--FROM dbo.eng_ECN_Reason T2 JOIN inp_Picklist_CO P ON T2.ECN=P.ECN
--GO
