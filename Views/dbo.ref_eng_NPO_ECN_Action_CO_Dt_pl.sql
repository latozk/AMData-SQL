...
CREATE VIEW [dbo].[ref_eng_NPO_ECN_Action_CO_Dt_pl] AS 
...
LEFT JOIN dbo.eng_NPO_ECN_Part_Loc_Unit_Contract_Div_Concat_CO_Dt_pl u ON t1.ECN=u.ECN AND t1.Key_1=u.PN
LEFT JOIN dbo.eng_ECN_Part_Dwg_Concat_CO_Dt_pl c ON t1.ECN=c.ECN AND t1.Key_1=c.PN
LEFT JOIN dbo.eng_NPO_Part_Dist_CORE_Concat_CO_Dt_pl cd ON t1.Key_1=cd.PN
LEFT JOIN dbo.eng_NPO_Part_Dist_Agile_Concat_CO_Dt_pl ad ON t1.Key_1=ad.PN
