...
CREATE procedure [dbo].[sp_ref_CORE_PN_XRef] as
...
(
SELECT
substring(ltrim(rtrim(am.PN)),1,15) as CORE_PN
, substring(ltrim(rtrim(am.AMPN)),1,15) as PN
, c.hy_fmt AS PN_Brand
, substring(ltrim(rtrim(am_1.AMPN)),1,15) as XPN
