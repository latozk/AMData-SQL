...
CREATE  Procedure [dbo].[sp_wrk_Product_Structure_All]
as 
...
--It is similar to sp_wrk_Product_Structure, but gets ADDs and REMs for cancelled and non-cancelled parents.
