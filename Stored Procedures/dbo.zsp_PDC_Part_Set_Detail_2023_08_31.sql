...
CREATE PROCEDURE [dbo].[zsp_PDC_Part_Set_Detail_2023_08_31]  AS
...
----2023-08-31 Added code to populate the SPN field (this needs removed when SPN goes to production) - Lines 690-695
---- =============================================
