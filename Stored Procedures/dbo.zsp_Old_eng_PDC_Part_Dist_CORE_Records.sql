...
CREATE  Procedure [dbo].[zsp_Old_eng_PDC_Part_Dist_CORE_Records] as
...
--Author: Newell, R
--Date: 2022-02-21
--Purpose:Append records to eng_PDC_Part_Dist_CORE
--
...
Select Distinct u.Unit
  ...
  Left Join eng_PDC_Part_Dist_Agile a
  On  u.Unit=a.Unit And u.Contract=a.Contract And u.Div=a.Div
  Left Join eng_PDC_Part_Dist_Agile c
...
--Insert into eng_PDC_Part_Dist_CORE
Select t1.*
INTO Test_PDC
From t1 Left outer join eng_Pdc_Part_Dist_Core s on
t1.Unit = s.Unit
