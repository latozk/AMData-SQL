...
SET ANSI_NULLS ON
GO
CREATE Procedure [dbo].[sp_eng_Prod_Structure_Tree_Picklist] @AS_DT date
as 
...
--                                   2020-08-13 - Changed so duplicates being avoided at point of entry instead of end.
-- =============================================
...
/* This was changed 2020-08-13 so it checks for duplicates when the records are loaded instead of deleteing them at the end
Insert into res_eng_Part_Structure 
...
/* Removed 2020-08-13 - duplicates now being elimated at point of entry
With t1 as (
SELECT Parent_PN
, Seq, COUNT(*) Dup_Count
...
GO
GRANT EXECUTE ON  [dbo].[sp_eng_Prod_Structure_Tree_Picklist] TO [GLOBAL\AP PDC Users]
GO
GRANT EXECUTE ON  [dbo].[sp_eng_Prod_Structure_Tree_Picklist] TO [GLOBAL\apcsmith]
GO
GRANT EXECUTE ON  [dbo].[sp_eng_Prod_Structure_Tree_Picklist] TO [GLOBAL\apdteagu]
GO
