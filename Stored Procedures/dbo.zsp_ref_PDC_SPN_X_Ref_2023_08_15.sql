...
CREATE PROCEDURE [dbo].[zsp_ref_PDC_SPN_X_Ref_2023_08_15]  AS
...
--Set c3a':  Gets non-cancelled CORE SPNs which have non-OBS AM PNs equal to PDC PNs
...
--Set c6a:  Gets all SPNs not already loaded to the SPN X-Ref table using OBS AM PNs where PM PN not cancelled
-----Gets PDC PNs equal to obsoleted AM PNs even if OBS date not equal to CORE PN CAN date.
-----This could pick up AM PNs obsoleted due to NSS.
...
Left Join dbo.ref_PDC_SPN_X_Ref x
On d.PN=x.PN
Where x.PN Is Null And (d.PN Like 'S__________[0-9]' or d.PN Like 'U__________[0-9]') And d.PN<>'S0104676  02'
)
...
(
Select 
--2023-07-24 LTrim(RTrim(d.PN)) As SPN
	Case 
		When LTrim(RTrim(d.PN)) Like '_______ [A-Z]'
		Then Left(LTrim(RTrim(d.PN)),7)+Right(LTrim(RTrim(d.PN)),1)
		When LTrim(RTrim(d.PN)) Like '_______ [A-Z][A-Z]'
		Then Left(LTrim(RTrim(d.PN)),7)+Right(LTrim(RTrim(d.PN)),2)
		When LTrim(RTrim(d.PN)) Like '_______ [A-Z]_'
		Then Left(LTrim(RTrim(d.PN)),7)+Right(LTrim(RTrim(d.PN)),2)
		When LTrim(RTrim(d.PN)) Like '_______ [A-Z]__'
		Then Left(LTrim(RTrim(d.PN)),7)+Right(LTrim(RTrim(d.PN)),3)
		When LTrim(RTrim(d.PN)) Like '________ [A-Z]'
		Then Left(LTrim(RTrim(d.X_PN)),8)+Right(LTrim(RTrim(d.PN)),1)
		When LTrim(RTrim(d.PN)) Like '________ [A-Z][A-Z]'
		Then Left(LTrim(RTrim(d.PN)),8)+Right(LTrim(RTrim(d.PN)),2)
		Else LTrim(RTrim(d.PN))
		End As SPN
	  ,d.PN
...
SELECT 
--2023-07-24
--LTRIM(RTrim(Hys_Part_No)) As SPN
	Case 
		When LTrim(RTrim(Hys_Part_No)) Like '_______ [A-Z]'
		Then Left(LTrim(RTrim(Hys_Part_No)),7)+Right(LTrim(RTrim(Hys_Part_No)),1)
		When LTrim(RTrim(Hys_Part_No)) Like '_______ [A-Z][A-Z]'
		Then Left(LTrim(RTrim(Hys_Part_No)),7)+Right(LTrim(RTrim(Hys_Part_No)),2)
		When LTrim(RTrim(Hys_Part_No)) Like '_______ [A-Z]_'
		Then Left(LTrim(RTrim(Hys_Part_No)),7)+Right(LTrim(RTrim(Hys_Part_No)),2)
		When LTrim(RTrim(Hys_Part_No)) Like '_______ [A-Z]__'
		Then Left(LTrim(RTrim(Hys_Part_No)),7)+Right(LTrim(RTrim(Hys_Part_No)),3)
		When LTrim(RTrim(Hys_Part_No)) Like '________ [A-Z]'
		Then Left(LTrim(RTrim(Hys_Part_No)),8)+Right(LTrim(RTrim(Hys_Part_No)),1)
		When LTrim(RTrim(Hys_Part_No)) Like '________ [A-Z][A-Z]'
		Then Left(LTrim(RTrim(Hys_Part_No)),8)+Right(LTrim(RTrim(Hys_Part_No)),2)
		Else LTrim(RTrim(Hys_Part_No))
		End As SPN
      ,Case
...
(  
SELECT 
--2023-07-24 LTRIM(RTrim(Hys_Part_No)) As SPN
	Case 
		When LTrim(RTrim(Hys_Part_No)) Like '_______ [A-Z]'
		Then Left(LTrim(RTrim(Hys_Part_No)),7)+Right(LTrim(RTrim(Hys_Part_No)),1)
		When LTrim(RTrim(Hys_Part_No)) Like '_______ [A-Z][A-Z]'
...
--RTrim(LTrim(d.PN)) As SPN
	Case 
		...
		Then Left(LTrim(RTrim(d.PN)),7)+Right(LTrim(RTrim(d.PN)),3)
		When LTrim(RTrim(d.PN)) Like '________ [A-Z]'
		Then Left(LTrim(RTrim(d.PN)),8)+Right(LTrim(RTrim(d.PN)),1)
		When LTrim(RTrim(d.PN)) Like '________ [A-Z][A-Z]'
		Then Left(LTrim(RTrim(d.PN)),8)+Right(LTrim(RTrim(d.PN)),2)
		Else LTrim(RTrim(d.PN))
		End As SPN
...
Select Distinct 
--2023-07-24
--LTrim(RTrim(d.X_PN)) As SPN
	Case 
		When LTrim(RTrim(d.X_PN)) Like '_______ [A-Z]'
		Then Left(LTrim(RTrim(d.X_PN)),7)+Right(LTrim(RTrim(d.X_PN)),1)
		When LTrim(RTrim(d.X_PN)) Like '_______ [A-Z][A-Z]'
		Then Left(LTrim(RTrim(d.X_PN)),7)+Right(LTrim(RTrim(d.X_PN)),2)
		When LTrim(RTrim(d.X_PN)) Like '_______ [A-Z]_'
		Then Left(LTrim(RTrim(d.X_PN)),7)+Right(LTrim(RTrim(d.X_PN)),2)
		When LTrim(RTrim(d.X_PN)) Like '_______ [A-Z]__'
		Then Left(LTrim(RTrim(d.X_PN)),7)+Right(LTrim(RTrim(d.X_PN)),3)
		When LTrim(RTrim(d.X_PN)) Like '________ [A-Z]'
		Then Left(LTrim(RTrim(d.X_PN)),8)+Right(LTrim(RTrim(d.X_PN)),1)
		When LTrim(RTrim(d.X_PN)) Like '________ [A-Z][A-Z]'
		Then Left(LTrim(RTrim(d.X_PN)),8)+Right(LTrim(RTrim(d.X_PN)),2)
Else LTrim(RTrim(d.X_PN))
End As SPN
--2023-07-24
	  ,d.PN
...
(
Select Distinct 
--2023-07-24 LTrim(RTrim(d.X_PN)) As SPN
	Case 
		When LTrim(RTrim(d.X_PN)) Like '_______ [A-Z]'
		Then Left(LTrim(RTrim(d.X_PN)),7)+Right(LTrim(RTrim(d.X_PN)),1)
		When LTrim(RTrim(d.X_PN)) Like '_______ [A-Z][A-Z]'
