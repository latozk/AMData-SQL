...
CREATE PROCEDURE [dbo].[sp_PDC_Part_Set_Detail]  AS

/*2023_09_05: Added back in the link to MDI_SS to get the Safety Stock.
Since this sp is ran at 7 am it is going to be getting the previous day numbers.
When the sp_PDC_Part_Set_Detail_SS_update is ran (Currently at 8:30) it will
populate the current days numbers and then update the part set detail table
*/
...
----2023-04-13 Added the SPN field to the Part Set Details table
---- =============================================
