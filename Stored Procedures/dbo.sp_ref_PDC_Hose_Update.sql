...
CREATE Procedure [dbo].[sp_ref_PDC_Hose_Update] AS

---- =============================================
----Author: Newell, R ; Sexton, C
----Date: 2022-08-01
----Revisions:
----2023_09_27 see changes with this date
...
SELECT DISTINCT 
   Case
		When Part_No Like ' %'
--2023_09_27 Then Right(Part_NO,7) replaced with the following	
		Then Right(RTrim(Part_NO),7)
		Else Part_No
		End AS PN
  ,Case
