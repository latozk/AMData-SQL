CREATE TABLE [dbo].[zeng_AM_VPN_Master]
(
...
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20200831-133910] ON [dbo].[zeng_AM_VPN_Master] ([Abbr], [PN]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [ClusteredIndex-20200831-133834] ON [dbo].[zeng_AM_VPN_Master] ([PN]) ON [PRIMARY]
GO
