CREATE TABLE [dbo].[zchain_BOM_OriginalFmt_Corrected_BulkPNs]
(
...
[OEM] [nvarchar] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HPN-YPN] [nvarchar] (16) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[ProdPN1] [nvarchar] (16) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HPN] [nvarchar] (16) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ProdPN2] [nvarchar] (16) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[zchain_BOM_OriginalFmt_Corrected_BulkPNs] ADD CONSTRAINT [PK_chain_BOM_Old] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
