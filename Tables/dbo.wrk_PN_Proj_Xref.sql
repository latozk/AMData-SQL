CREATE TABLE [dbo].[wrk_PN_Proj_Xref]
(
...
GO
CREATE CLUSTERED INDEX [ClusteredIndex-20200508-101833] ON [dbo].[wrk_PN_Proj_Xref] ([PN], [Proj], [Init_PN]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_ref_PN_Proj_Xref_Proj_PN] ON [dbo].[wrk_PN_Proj_Xref] ([Proj], [PN]) ON [PRIMARY]
GO
