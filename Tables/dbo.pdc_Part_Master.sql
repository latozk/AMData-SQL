CREATE TABLE [dbo].[pdc_Part_Master]
(
...
[Replaced_Date] [varchar] (7) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Allocate_Tag] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Re_Sourcing_Tag] [varchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[SLS_Avail_Date] [varchar] (7) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CYC_ABC] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HDLG_Cat] [char] (3) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Alpha] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Stk_Part_Tag] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Inspect_Code] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Curr_Tag] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Chg_Date_Time] [varchar] (23) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Origin_Dt] [date] NULL,
[Inact_Dt] [date] NULL,
[Last_Rcpt_Dt] [date] NULL,
[Last_Tran_Dt] [date] NULL,
[Replaced_Dt] [date] NULL,
[SLS_Avail_Dt] [date] NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[pdc_Part_Master] ADD CONSTRAINT [PK_pdc_Part_Master] PRIMARY KEY CLUSTERED ([Part_No]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idxPDCPM_CompPurchCd] ON [dbo].[pdc_Part_Master] ([Comb_Purch_Code]) ON [PRIMARY]
GO
