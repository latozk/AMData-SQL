CREATE TABLE [dbo].[eng_Agile_Distribution_REMs]
(
...
GO
CREATE CLUSTERED INDEX [ClusteredIndex-20220314-095422] ON [dbo].[eng_Agile_Distribution_REMs] ([Unit], [Contract], [Div], [PN]) ON [PRIMARY]
GO
