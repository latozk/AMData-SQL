CREATE TABLE [dbo].[zeng_Part_ECN_History]
(
...
GO
CREATE NONCLUSTERED INDEX [idx_eng_Part_ECN_History_ecn] ON [dbo].[zeng_Part_ECN_History] ([ECN]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [idx_eng_Part_ECN_History_PN_ECN] ON [dbo].[zeng_Part_ECN_History] ([PN], [ECN]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20210616-114627] ON [dbo].[zeng_Part_ECN_History] ([PN], [Rel_Dt]) ON [PRIMARY]
GO
