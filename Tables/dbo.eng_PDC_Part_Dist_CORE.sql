CREATE TABLE [dbo].[eng_PDC_Part_Dist_CORE]
(
...
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20221024-130333] ON [dbo].[eng_PDC_Part_Dist_CORE] ([Unit], [Contract], [Div], [List], [PN]) ON [PRIMARY]
GO
